...
function symlink_files() {
  ignoredfiles=(temp LICENSE readme.md install.sh get-omzsh.sh zsh-theme)
...
function setup_git() {
  ...
  git config --global user.name neyangg 
  #read -p 'Enter email: ' GIT_EMAIL
  #git config --global user.email $GIT_EMAIL
  git config --global user.email jerryjia92@gmail.com
